  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 md:px-10 flex items-center justify-between">
        ...
        {/* Logo and Brand Name */}
        <Link to="/" className="flex items-center gap-2.5 group py-4" data-testid="nav-logo">
          ...
          <span className="text-white text-2xl tracking-tight font-serif italic">
            ...
            <span className="text-red-600 font-light ml-1.5">Capsule</span>
          </span>
        </Link>
            ...
            <NavLink key={to} to={to} className={linkClass}>
              {({ isActive }) => (
                <>
                  ...
                  <Icon className={`w-4 h-4 transition-colors duration-300 ${isActive ? "text-red-500" : "group-hover:text-white"}`} />
                  
                  <span className="relative z-10">{label}</span>
                  
                  {/* Premium Active Indicator: Line + Glow */}
                  {isActive && (
                    <>
